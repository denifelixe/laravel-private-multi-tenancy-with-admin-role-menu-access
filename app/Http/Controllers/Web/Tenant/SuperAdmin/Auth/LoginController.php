...
use App\Http\Requests\Web\Tenant\SuperAdmin\Auth\Login\LoginRequestValidation;
...
class LoginController extends Controller
{
    ...
    {   
        ...
        if (Auth::guard('web_tenant_superadmin')->attempt($credentials)) {
            /*
    ...
    {
        Auth::guard('web_tenant_superadmin')->logout();

        return redirect()->route('web.tenant.superadmin.login', ['tenant' => subdomain()]);
    }
