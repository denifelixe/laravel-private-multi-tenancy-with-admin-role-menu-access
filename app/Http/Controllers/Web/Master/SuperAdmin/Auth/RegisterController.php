...
use App\Http\Requests\Web\Master\SuperAdmin\Auth\Register\RegisterRequestValidation;
...
class RegisterController extends Controller
{
    ...
    {
        return view('master.superadmin.auth.register');
    }
    ...
    public function SuperAdminRegister(RegisterRequestValidation $request)
    {
        ...
        Auth::guard('web_master_superadmin')->login($superadmin_created);
