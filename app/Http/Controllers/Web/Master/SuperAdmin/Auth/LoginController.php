...
namespace App\Http\Controllers\Web\Master\SuperAdmin\Auth;

use App\Http\Controllers\Controller;
use App\Http\Requests\Web\Master\SuperAdmin\Auth\Login\LoginRequestValidation;
...
class LoginController extends Controller
{
    ...
    {
    	return view('master.superadmin.auth.login');
    }

    public function superAdminLogin(LoginRequestValidation $request)
    {	
    	$credentials = $request->only('email', 'password');

        if (Auth::guard('web_master_superadmin')->attempt($credentials)) {
        	/*
			...
			*/
			...
			return redirect()->route('web.master.superadmin.dashboard');
        }
    ...
    {
    	Auth::guard('web_master_superadmin')->logout();
