...
namespace App\Http\Requests\API\Tenant\SuperAdmin\Auth\Register;

use App\Repositories\Tenant\SuperAdmins\SuperAdminInterface;
use App\Rules\Unique\TenantSuperAdminRegistrationVerificationCodesEmailApplicantUniqueRule;
    ...
    public function rules()
    {
        ...
        return [
            'email' => [
                ...
                resolve(TenantSuperAdminRegistrationVerificationCodesEmailApplicantUniqueRule::class)
            ]
        ];
    }
}
